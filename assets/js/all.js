...
var navToggleTitle = navToggle.getAttribute("title"); //點漢堡icon時

navToggle.onclick = function () {
  //增加一個active的class
  nav.classList.toggle("active"); // //修改title的值為收合選單
    ...
    function o(e) {
      ...
      if (t.realIndex !== s.realIndex || l) {
        ...
        if (s.params.loop) {
          ...
          _i19 = void 0 === _e75 ? _a29 : void 0 === _a29 ? _e75 : _a29 - _o6 == _o6 - _e75 ? s.params.slidesPerGroup > 1 ? _a29 : _o6 : _a29 - _o6 < _o6 - _e75 ? _a29 : _e75, _r11 = t.activeIndex > t.previousIndex ? "next" : "prev";
            ...
            if (r.freeMode.momentum) {
              if (d.velocities.length > 1) {
                var _e77 = d.velocities.pop(),
                    ...
                    _i20 = _e77.time - _s47.time;

                t.velocity = _a30 / _i20, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i20 > 150 || u() - _e77.time > 300) && (t.velocity = 0);
              } else t.velocity = 0;
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _a34 = 0; _a34 < e.length; _a34 += 1) {
          ...
          var _i22 = -_e80[0].swiperSlideOffset;
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e83 = 0, _t58 = a.length; _e83 < _t58; _e83 += 1) {
          var _t59 = a.eq(_e83),
              _s52 = i[_e83],
              _l8 = (o - _t59[0].swiperSlideOffset - _s52 / 2) / _s52,
